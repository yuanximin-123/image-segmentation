...
if __name__ == "__main__":
    ...
    name_classes    = ["background","wound","boundary"]
    #----------------------------------------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        # 指定文件夹路径
        source_folder_path = r"D:\project\picture_cut\unet-pytorch-main\unet-pytorch-main\VOCdevkit\VOC2007\Predict_JPEGImages"
        destination_folder_path = r"D:\project\picture_cut\unet-pytorch-main\unet-pytorch-main\VOCdevkit\VOC2007\Predit_Images"
        ...
        for file_name in os.listdir(source_folder_path):
            if file_name.endswith(".jpg"):
                ...
                # r_image.save(destination_folder_path)

                file_name_without_extension = os.path.splitext(file_name)[0]
                destination_file_path = os.path.join(destination_folder_path, file_name_without_extension + ".png")
                r_image.save(destination_file_path, format="PNG")
