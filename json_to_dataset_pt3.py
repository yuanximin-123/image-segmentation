...
def Jsontopng(Yuan_path, num):
    jpgs_path = "unet-pytorch-main/datasets/JPEGImages"
    pngs_path = "unet-pytorch-main/datasets/SegmentationClass"
    classes = ["_background_", "wound", "boundary"]
    ...
    for i in range(0, len(count)):
        ...
        if os.path.isfile(path) and path.endswith('json'):
            ...
            label_name_to_value = {'_background_': 0, 'wound': 1, 'boundary': 2}
